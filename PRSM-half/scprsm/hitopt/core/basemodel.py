...
from ..utils.tools import protect
...
class BaseModel(metaclass=protect("train", "__init__")):
    ...
    def __lazy_initialize__(self):
        params = self.kwargs['model_config'].parameters
        configs = self.kwargs['model_config'].configs
        repo = configs['repo']
        overrideUnfinished = configs['overrideUnfinished']
